...
const Policy = () => (
  <>
    <Container>
      ...
      <p>
        If you have a order with us, we will always remember and be grateful for working with you, the data we collect will still be stored within our system until it is removed or if the order is done. If you want us to remove the information provided, we will sure be happy to.
      </p>
      <h1>
        WHAT ABOUT PAYMENT
      </h1>
      <p>
        We do not handle payment directly, we use third party tools of Venmo, Apple Pay and Cash app to use for payment of orders. All Payment and credit card information is all done so via those app, we do not store or keep track of your credit card information. Whatever you have questions or concerns within the app, you would contact the application itself. We don't have any control within their systems. We only get the payment and check off if the order is paid or not.
      </p>
    </Container>
  </>
)
